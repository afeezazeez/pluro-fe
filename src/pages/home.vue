...
const uploadFile = async () => {
    ...
    try {
        const {data:{data}} = await axios.post(`${import.meta.env.VITE_APP_URL}/v1/upload`, formData);
        if (data) {
...
<template>
    ...
    <div class="min-h-screen bg-gray-100 flex flex-col items-center p-6">
        ...
        <h1 class="text-2xl font-bold  mb-6 text-red-500">File Upload for Accessibility/Compliance Check</h1>
